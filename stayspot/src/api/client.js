...
// export const getCategoryFeed = (slug, page = 1, limit = 12) =>
//   fetch(`${API_BASE}/posts/category/${slug}?page=${page}&limit=${limit}`)
//     .then((res) => {
//       if (!res.ok) throw new Error("Failed to load category posts");
//       return res.json();
//     })
...
// export const getSubcategoriesByCategory = (token, categoryId) =>
//   api
//     .get(`/admin/subcategories/category/${categoryId}`, {
//       headers: { Authorization: `Bearer ${token}` },
//     })
//     .then((res) => res.data);
...
//   api
//     .get("/admin/subcategories/admin", {
//       headers: { Authorization: `Bearer ${token}` },
//     })
//     .then((res) => res.data);

// // Admin: create subcategory
// export const createSubcategory = (token, data) =>
//   api
//     .post("/admin/subcategories/admin", data, {
//       headers: { Authorization: `Bearer ${token}` },
//     })
//     .then((res) => res.data);
...
//   api
//     .put(`/admin/subcategories/admin/${id}`, data, {
//       headers: { Authorization: `Bearer ${token}` },
//     })
//     .then((res) => res.data);
...
//   api
//     .delete(`/admin/subcategories/admin/${id}`, {
//       headers: { Authorization: `Bearer ${token}` },
//     })
//     .then((res) => res.data);
